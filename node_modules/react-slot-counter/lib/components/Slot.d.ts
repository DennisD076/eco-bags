...
declare function Slot({ isNew, charClassName, numbersRef, active, isChanged, effectiveDuration, delay, value, startValue, disableStartValue, dummyList, hasSequentialDummyList, hasInfiniteList, valueClassName, numberSlotClassName, numberClassName, reverse, sequentialAnimationMode, useMonospaceWidth, maxNumberWidth, onFontHeightChange, }: Props): JSX.Element;
